				...
				<tbody>
					...
					@foreach($lista_reporte as $reporte)
						<tr>
							...
							<td style="width: 40%; text-align: center;">{{$reporte['alumno']}}</td>
							...
							<td style="width: 10%; text-align: center;">{{$reporte['promedio_aptitudinal']}}</td>
							<td style="width: 10%; text-align: center;">{{$reporte['promedio_letra']->nombre}}</td>
						</tr>
					@endforeach
				</tbody>
			</table>
