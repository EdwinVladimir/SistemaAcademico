<template>
    <div>
        <h1 class="text-center">Reporte de Cursos</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-4 col-12">
                        <div class="form-group">
                            ...
                            <select v-model="curso_id" class="form-control" required>
...
export default {
    ...
    methods: {
        ...
        {
           // window.open(''+ this.curso_id +'/'+ this.periodo_id);
            $('#viePDF').attr('src', '../reporte/cursos/descargar/'+ this.curso_id +'/'+ this.periodo_id +'/'+ type);
        },
    },
};
</script>
