<template>
    <div>
        <h1 class="text-center">Reporte de Aptitud por Materias</h1>
...
export default {
    ...
    methods: {
        ...
        async descargar(type)
        {
            ...
            $('#viePDF').attr('src', '../reporte/registro-notas-aptitud/descargar/'+ this.curso_id +'/'+ this.materia_id +'/'+ this.periodo_id +'/'+ this.docente_id +'/'+ type);
        },
    },
};
</script>
